...
class SyncRandomAffine():
    ...
    def __call__(self, img, mask):
        ...
        img_prime = F.affine(img, *ret, interpolation=self.trans.resample, fill=self.trans.fillcolor)
        mask_prime = F.affine(mask, *ret, interpolation=self.trans.resample, fill=self.trans.fillcolor)
